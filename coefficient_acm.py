...
# Load the CSV files
interactions_file_path = r'acm/20210217.csv'
user_data_file_path = r'acm/user_data.csv'
...
# Filter interactions to find authors who used the word "acm"
filtered_interactions_df = interactions_df[interactions_df['text'].str.contains('acm')]
...
def coefficient_acm():
    ...
    # Calculate total number of interactions containing "acm"
    ...
    # Calculate engagement coefficient for the topic "acm"
    ...
    print(f'\nOverall engagement coefficient for the topic "acm": {engagement_coefficient:.8f}')
